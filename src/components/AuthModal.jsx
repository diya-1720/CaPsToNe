    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-md glass-card p-6 sm:p-8 rounded-3xl border border-cyan-500/30 shadow-2xl space-y-5 text-left bg-[#0d1527]">
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-2xl bg-white hover:bg-slate-100 text-slate-900 font-medium text-xs shadow-lg transition-all flex items-center justify-center gap-3 disabled:opacity-50"
        >
